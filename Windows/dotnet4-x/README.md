...
the control-flow diagram are in **[docs/architecture.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/concepts/architecture.md)**.
...
[RatchetBox](https://github.com/CurtisDSlone/RatchetBox) holds ready-made ratchets: `dotnet4-x` (the C#
...
See **[docs/console.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/use-the-console.md)** for the full command set and the project lifecycle. Prefer
...
[RatchetBox](https://github.com/CurtisDSlone/RatchetBox)) holds transcripts of building projects with
...
[RatchetBox](https://github.com/CurtisDSlone/RatchetBox) to start.
...
Binding, the repair loop) - is in **[docs/ratchets.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/build-a-ratchet.md)**.
...
**[docs/mcp.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/drive-over-mcp.md)**. Because SAC blocks the bare `.exe`, point clients at `run-cli.ps1`.
...
[SECURITY.md](https://github.com/CurtisDSlone/Ratchet/blob/main/SECURITY.md).
...
Build internals and the `src/` layout are in **[docs/architecture.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/concepts/architecture.md)**.

## Documentation

- **[docs/architecture.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/concepts/architecture.md)** - the propose/verify thesis, how a local model
  changes ICM, the control-flow diagram, and the `src/` layout.
- **[docs/ratchets.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/build-a-ratchet.md)** - the ratchet contract: `ratchet.json`, the kb manifest,
  tools, and action chains (node kinds, input bindings, the bounded repair loop).
- **[docs/console.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/use-the-console.md)** - operating the console: every command, the router and model
  seats, workspaces, and the project lifecycle (scaffold → add/edit → build → launch).
- **[docs/mcp.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/drive-over-mcp.md)** - driving the ratchet from a frontier model over MCP.

Technical guides (authoring):
- **[docs/context-binding.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/concepts/context-binding.md)** - the deep dive on Context Binding (the
  three layers, code snippets, how it composes with the Oracle).
- **[docs/authoring-flows.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/author-flows.md)** - action chains / prompt chaining: node kinds,
  bindings, the bounded repair loop, run state, linting.
- **[docs/authoring-tools.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/how-to/author-tools.md)** - tools: the manifest, the runtime contract,
  stdin/BOM, exit-code-as-verdict, MCP exposure.
- **[docs/gemini-hack.md](https://github.com/CurtisDSlone/Ratchet/blob/main/docs/agents/frontier-prompting.md)** - have a browser frontier model read these docs and
